...
using System;
using Trezorix.Checkers.ExcelXmlChecker.Properties;

namespace Trezorix.Checkers.ExcelXmlChecker
{
	public static class ExcelXmlCheckerConfig
	{
		public static string SolrIndexUrl;
		
		static ExcelXmlCheckerConfig()
		{
